...
export default function IncomingCallDialog({ callerName, onAccept, onReject, isVideo }) {
  return (
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-1 -right-1 bg-green-500 p-1.5 rounded-full border-2 border-card">
                {isVideo ? <Video className="h-3 w-3 text-white fill-current" /> : <Phone className="h-3 w-3 text-white fill-current" />}
              </div>
            </div>
          </div>
